...
- [ ] Commit subject is a conventional-commit line that reads well as a release note — CHANGELOG.md is generated by release-please from those subjects and is **never hand-edited**; a manually added section is overwritten on the next release PR
