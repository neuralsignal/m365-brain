...
from m365_brain.config import SharePointExtractorConfig
...
from m365_brain.m365.frontmatter import SharePointFileData, build_sharepoint_frontmatter
...
def _sync_drive(
    ...
    prefix = ctx.paths.inbox_item(name, site_slug, drive_slug)
