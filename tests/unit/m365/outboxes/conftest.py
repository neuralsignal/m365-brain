...
def outboxes_config(attachment_root, signature):
    return OutboxesConfig(
        ...
        definitions={
            ...
            "email.reply": OutboxDefinitionConfig(tier="draft_only", auth_profile="mail"),
            "email.forward": OutboxDefinitionConfig(tier="draft_only", auth_profile="mail"),
            "teams.post_message": OutboxDefinitionConfig(tier="auto_send", auth_profile="teams"),
            "file.update": OutboxDefinitionConfig(tier="auto_send", auth_profile="files"),
        },
